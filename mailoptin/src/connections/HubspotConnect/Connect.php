        ...
        try {
            ...
            if (empty($options) || false === $options) {
                ...
                $response = $this->hubspotInstance()->apiRequest(
                    sprintf('properties/v1/contacts/properties/named/%s', $property)
                );
                ...
                if (isset($response->options)) {
                    ...
                    set_transient($cache_key, $options, 30 * MINUTE_IN_SECONDS);
                }
            }
        ...
        try {
            ...
            if (empty($options) || false === $options) {
                ...
                if ( ! empty($response->results)) {
                    ...
                    set_transient('mo_hubspot_get_owners', $options, 30 * MINUTE_IN_SECONDS);
                }
            }
    ...
    public function get_email_list()
    {
        ...
        try {
            ...
            if (empty($lists) || false === $lists) {
                ...
                set_transient('mo_hubspot_get_email_list', $lists, 10 * MINUTE_IN_SECONDS);
            }
    ...
    public function get_optin_fields($list_id = '')
    {
        try {
            ...
            if (empty($fields) || false === $fields) {
                ...
                set_transient($cache_key, $fields, 30 * MINUTE_IN_SECONDS);
            }
