...
class SPLC_Free_Loader {
	...
	public function __construct() {
		...
		require_once SP_LC_PATH . 'admin/lcf-mce-button/button.php';
	}
				...
				<div class="row">
					<div class="sp-lc__col-xl-6">
						<div class="sp-lc__banner-content">
							...
							<p class="sp-lc__mt-20 text-color-2 sp-lc__line-height-20 sp-lc__font-weight-400"><?php echo esc_html__( 'Create a <strong>Carousel, Grid, Isotope Filter, List, and Inline</strong> view of logo images with Title, Description, Read more, Tooltips, Links (Internal or External) and Popup, etc.', 'logo-carousel-free' ); ?></p>
						</div>
			...
			<div class="sp-lc__container">
				...
				<div class="video-area text-center">
					...
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/2R16tCBOw-s">
		...
		<div class="sp-logo-carousel-help-page">
				...
				<section class="sp-lc-help header">
					...
					<div class="video-area">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/nWuTLgmAzd0" frameborder="0" allowfullscreen=""></iframe>
					</div>
