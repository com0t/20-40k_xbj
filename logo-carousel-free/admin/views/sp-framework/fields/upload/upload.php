...
if ( ! class_exists( 'SPLC_FREE_Field_upload' ) ) {
	...
	class SPLC_FREE_Field_upload extends SPLC_FREE_Fields {
		...
		public function render() {
			...
			echo '<a href="#" class="button button-primary splogocarousel--button" data-library="' . esc_attr( $library ) . '">' . esc_html( $args['button_title'] ) . '</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
