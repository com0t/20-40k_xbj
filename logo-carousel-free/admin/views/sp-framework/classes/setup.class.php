	...
	class SPLC {
		...
		public static function add_admin_enqueue_scripts() {
			...
			wp_localize_script(
				...
				array(
					...
					'previewJS'     => SP_LC_URL . 'public/assets/js/splc-script' . $min . '.js',
					'i18n'          => array(
		...
		public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
			...
			if ( ! empty( $field_type ) ) {
				...
				echo '<div class="splogocarousel-field splogocarousel-field-' . $field_type . $is_pseudo . $class . $visible . '"' . $depend . '>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
